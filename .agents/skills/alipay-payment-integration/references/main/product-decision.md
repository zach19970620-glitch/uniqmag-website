...
| 402协议、Agent收款、A2A、ACT协议、A2M、AI支付、Agent支付 | AI 收     |
...
8. AI 收
   - 面向 Agent 的支付解决方案，基于 402 payment required 状态码实现支付
   - 适用：API、数字内容或算力资源，向访问它们的 AI 智能体（AI Agents）发起收款
...
```
抱歉，当前仅支持以下支付产品：当面付、订单码支付、手机网站支付、电脑网站支付、JSAPI 支付、App 支付、预授权支付、商家扣款、AI收。
