        ...
        >
          ...
          <div className={`grid gap-6 ${product.highlights.length === 4 ? 'sm:grid-cols-2 lg:grid-cols-4' : 'md:grid-cols-3'}`}>
            {product.highlights.map((item) => (
              <div key={item.title} className="glass-panel p-8 rounded-3xl glass-panel-hover group">
                <div 
            ...
            <div className="md:w-2/3">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4">
                {product.specs.map((spec) => (
                  <div key={spec.label} className="py-4 border-b border-white/5 flex flex-col gap-1">
